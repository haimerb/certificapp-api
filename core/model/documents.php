...
class organization {
	...
	/**
	 * recupera todos los organizations
	 */
	...
	public function save($param){
		...
		if(isset($param["id"]) and $param["id"] !=''){
			$actualorganization = $this->getorganizationById($param["id"]);
			if(isset($actualorganization["id"])){
				$exists = true;	
				/**
				 * Valores actuales
				 */
